...
public class ImageServiceImpl implements ImageService {
	...
	@Override
	public Image uplaodImageEv(MultipartFile file, Long idEv) throws IOException {
		Evenement ev = new Evenement();
		ev.setIdEvenement(idEv);;
	...
	@Override
	public List<Image> getImagesParEv(Long evId) {
		Evenement ev = evenementRepository.findById(evId).get();
		return ev.getImages();
	}
